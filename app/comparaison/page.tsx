          ...
          <div className="space-y-4">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5">
                ...
                <Card>
                  <CardHeader title="Par aire de santé (supervision conjointe)" />
