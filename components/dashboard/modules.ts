...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    desc: "Suivi mensuel des activités des Assistants Techniques — réunions, supervisions, monitorage, surveillance et rapports (temps réel).",
    pages: [
      { id: "rap_vue", label: "Vue d'ensemble", icon: "overview", lvl: "all" },
      { id: "rap_reunions", label: "Tenue des réunions", icon: "comment", lvl: "all" },
      { id: "rap_supervisions", label: "Supervisions", icon: "link", lvl: "all" },
      { id: "rap_monitorage", label: "Monitorage de convenance", icon: "gauge", lvl: "all" },
      { id: "rap_surveillance", label: "Surveillance", icon: "erreurs", lvl: "all" },
      { id: "rap_osp", label: "OSP & rapports", icon: "check", lvl: "all" },
    ],
  },
  {
